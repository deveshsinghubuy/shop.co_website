...
//   const products =[
//     {id:1, image:"/products/product5.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:2, image:"/products/product6.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:3, image:"/products/product7.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:4, image:"/products/product8.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:5, image:"/products/product5.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:6, image:"/products/product6.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:7, image:"/products/product7.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//     {id:8, image:"/products/product8.png", title:"T-SHIRT WITH TAPE DETAILS", rating:"4.5/5", price:"$120", oldPrice:"$120", discount:"-20%"},
//   ]
  const firstBlock = products.slice(8, 12);
  const secondBlock = products.slice(12, 16);
  return (
        <div className='flex justify-center'>
            <div className='max-w-[2050px] w-full flex justify-center py-10 xl:py-20 border-b border-netural-300'>
                ...
                <div className='flex flex-col items-center gap-7 md:gap-12 xl:gap-14 '>
                    <h2 className='text-[32px] md:text-[48px] font-bold font-integral'>Top Selling</h2>
                    {/* products */}
                    <div>
